            ...
            {pressReleases.map((release, index) => (
              <Card key={index} className="h-full flex flex-col">
                ...
                <CardFooter className="mt-auto pt-4">
                  <Button asChild variant="ghost" className="text-indigo-600 dark:text-indigo-400 p-0 hover:bg-transparent hover:text-indigo-800 dark:hover:text-indigo-300 h-auto">
