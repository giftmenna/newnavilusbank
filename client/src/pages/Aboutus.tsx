          ...
          <div className="mt-10">
            <div className="prose prose-indigo mx-auto dark:prose-invert lg:max-w-none">
              ...
              <div className="mt-12 text-center">
                <Link href="/careers">
                  <a className="inline-block bg-indigo-600 text-white px-6 py-3 rounded-md font-medium hover:bg-indigo-700 transition-colors">
                    Join Our Team
                  </a>
                </Link>
                <Link href="/contact">
                  <a className="inline-block ml-4 bg-white dark:bg-gray-800 text-indigo-600 dark:text-indigo-400 border border-indigo-600 dark:border-indigo-400 px-6 py-3 rounded-md font-medium hover:bg-indigo-50 dark:hover:bg-gray-700 transition-colors">
                    Contact Us
                  </a>
                </Link>
              </div>
