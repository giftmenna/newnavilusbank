...
import { LineChartIcon, TrendingUpIcon, PieChartIcon, ArrowRightIcon, AlertCircleIcon, RefreshCcwIcon, InfoIcon, BarChart3Icon } from "lucide-react";
                ...
                <div key={account.id} className="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-green-600">+{account.returnPercentage}%</span>
                    </div>
                  </div>
                </div>
              ))}
